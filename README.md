...
[Paper PDF](paper/SUP-MIMIC.pdf) · [arXiv source](arxiv/README.md) · [Visual guide](docs/visual_guide.md) · [Tutorial](docs/tutorial.md) · [Reproducibility](docs/reproducibility_workflow.md) · [Compliance](docs/compliance.md) · [SQL](sql/README.md)
...
![Paper motivation](docs/assets/paper/intro.png)
...
![Method figure](docs/assets/paper/mth.png)
...
![Clinical category stratification](docs/assets/paper/AE1.png)
...
![Degradation analysis](docs/assets/paper/AE22.png)

![Scaling analysis](docs/assets/paper/AE3.png)

![Expert validation](docs/assets/paper/Expert.png)

![AUC comparison](docs/assets/paper/exp8_auc_comparison.png)

![EER improvement](docs/assets/paper/exp8_eer_improvement.png)
...
2. Load MIMIC-IV into a local database authorized for the study.
...
The `arxiv/source` folder contains the manuscript source package used for preprint preparation. It excludes reviewer-response drafts, build artifacts, download folders, and detailed patient-level error-case appendix material.
